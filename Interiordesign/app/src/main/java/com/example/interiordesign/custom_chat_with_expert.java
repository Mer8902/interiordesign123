...
public class custom_chat_with_expert extends BaseAdapter {
    ...
    public custom_chat_with_expert(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_chat_with_expert, null);
        ...
        ImageView b1=(ImageView) gridView.findViewById(R.id.imageView3);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent ik = new Intent(context.getApplicationContext(),Test.class);
//                ik.putExtra("cid",c.get(position));
