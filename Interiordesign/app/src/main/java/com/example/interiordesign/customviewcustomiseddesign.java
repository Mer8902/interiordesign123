...
public class customviewcustomiseddesign extends BaseAdapter {
    ...
    public customviewcustomiseddesign(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c,ArrayList<String> d,ArrayList<String> e) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.customviewcustomiseddesign, null);
        ...
        ImageView i1=(ImageView) gridView.findViewById(R.id.imageView5);
